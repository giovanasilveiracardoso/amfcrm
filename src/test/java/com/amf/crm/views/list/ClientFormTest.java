...
//    private List<Loan> companies;
//    private List<Status> statuses;
//    private Client marcUsher;
//    private Loan company1;
//    private Loan company2;
...
//        ClientForm form = new ClientForm(companies, statuses);
...
//
//        AtomicReference<Client> savedContactRef = new AtomicReference<>(null);
//        form.addSaveListener(e -> {
//            savedContactRef.set(e.getContact());
//        });
//        form.save.click();
//        Client savedContact = savedContactRef.get();
//
